...
local aa = {
    ...
    [53] = function()
		...
		return {
            ...
            AcrylicMain = Color3.fromRGB(15, 30, 60),
            AcrylicBorder = Color3.fromRGB(80, 140, 200),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(100, 180, 255), Color3.fromRGB(60, 120, 180)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(90, 150, 220),
            Tab = Color3.fromRGB(150, 200, 255),
            Element = Color3.fromRGB(120, 180, 255),
            ElementBorder = Color3.fromRGB(60, 100, 150),
            InElementBorder = Color3.fromRGB(90, 140, 200),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(120, 180, 255),
            ToggleToggled = Color3.fromRGB(10, 40, 80),
            SliderRail = Color3.fromRGB(120, 180, 255),
            DropdownFrame = Color3.fromRGB(180, 220, 255),
            ...
            InputFocused = Color3.fromRGB(30, 50, 100),
            ...
            DialogButtonBorder = Color3.fromRGB(90, 140, 200),
            DialogBorder = Color3.fromRGB(80, 130, 190),
            DialogInput = Color3.fromRGB(70, 120, 180),
