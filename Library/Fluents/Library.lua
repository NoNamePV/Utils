...
local aa = {
	...
	[48] = function()
		...
		return {
            ...
            AcrylicBorder = Color3.fromRGB(80, 120, 160),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 110, 170), Color3.fromRGB(30, 60, 100)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(70, 100, 140),
            Tab = Color3.fromRGB(120, 160, 200),
            Element = Color3.fromRGB(100, 140, 180),
            ElementBorder = Color3.fromRGB(40, 60, 90),
            InElementBorder = Color3.fromRGB(80, 110, 140),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(100, 140, 180),
            ToggleToggled = Color3.fromRGB(10, 20, 30),
            SliderRail = Color3.fromRGB(100, 140, 180),
            DropdownFrame = Color3.fromRGB(140, 180, 220),
            DropdownHolder = Color3.fromRGB(40, 55, 80),
            DropdownBorder = Color3.fromRGB(30, 45, 70),
            DropdownOption = Color3.fromRGB(100, 140, 180),
            Keybind = Color3.fromRGB(100, 140, 180),
            Input = Color3.fromRGB(100, 140, 180),
            InputFocused = Color3.fromRGB(20, 30, 40),
            InputIndicator = Color3.fromRGB(150, 190, 230),
            Dialog = Color3.fromRGB(40, 55, 80),
            DialogHolder = Color3.fromRGB(30, 40, 60),
            DialogHolderLine = Color3.fromRGB(25, 35, 55),
            DialogButton = Color3.fromRGB(40, 55, 80),
            DialogButtonBorder = Color3.fromRGB(70, 100, 130),
            DialogBorder = Color3.fromRGB(60, 90, 120),
            DialogInput = Color3.fromRGB(50, 70, 100),
            DialogInputLine = Color3.fromRGB(160, 190, 230),
            Text = Color3.fromRGB(230, 240, 255),
            SubText = Color3.fromRGB(160, 180, 200),
            Hover = Color3.fromRGB(100, 140, 180),
            HoverChange = 0.04            
		}
	end,
	[49] = function()
